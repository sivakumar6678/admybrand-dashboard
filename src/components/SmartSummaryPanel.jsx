...
const SmartSummaryPanel = ({ data, className }) => {
  ...
  return (
    <motion.div
      ...
      className={className}
    >
      <Card className="bg-gradient-to-r from-primary/5 via-purple-500/5 to-blue-500/5 border-primary/20 h-full flex flex-col">
              ...
              >
                {summary.keyMetrics?.revenue && (
                  <MetricBadge
                    icon={DollarSign}
                    label="Revenue"
                    value={`$${summary.keyMetrics.revenue.value.toLocaleString()}`}
